            ...
            if channel_layer:
                ...
                async_to_sync(channel_layer.group_send)(
                    group_name,
                    {
                        ...
                        "content": content,
                        "timestamp": _as_utc_z(message.timestamp),
    ...
    def get(self, request, project_id):
        ...
        for msg in msgs:
            ...
            messages.append({
                "id": str(msg.id),
                "content": msg.content,
                "timestamp": _as_utc_z(msg.timestamp) if msg.timestamp else None,
                "created_at": _as_utc_z(msg.timestamp) if msg.timestamp else None,
                "sender": {
                    "id": msg.sender,
