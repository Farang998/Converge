...
const formatISTTime = (timestamp, created_at) => {
  ...
  const messageDateIST = new Date(dateIST.getFullYear(), dateIST.getMonth(), dateIST.getDate());
  ...
  if (isToday) {
    ...
    const dateStr = date.toLocaleDateString("en-IN", {
      day: "numeric",
      month: "short",
      year: dateIST.getFullYear() !== nowIST.getFullYear() ? "numeric" : undefined,
      timeZone: "Asia/Kolkata",
    });
      ...
      case "image":
        return (
          <div className="message-image-container">
            <img src={file_url} alt={file_name || "Image"} className="message-image" />
          </div>
        );
      case "video":
        return (
