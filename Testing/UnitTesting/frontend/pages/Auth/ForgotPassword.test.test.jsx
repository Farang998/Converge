...
describe('ForgotPassword', () => {
  ...
  it('should validate OTP and show password reset form', async () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /validate otp/i }));
  ...
  it('should navigate back to email step from OTP step', async () => {
    api.post.mockResolvedValueOnce({
      data: { message: 'OTP sent' }
    });
    ...
    // Click back arrow
    const backArrow = screen.getByText('← Back');
